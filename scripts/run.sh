...
test_envs=2
gpu_ids=3
data_dir='/home/lzc/transferlearning/code/DeepDG/data/PACS/'
data_dir='/home/lzc/transferlearning/code/DeepDG_2/data/pacs_c/'
max_epoch=120
net='resnet50'
task='img_dg'
output='pacsoutput/resnet18/erm'

i=1
lr=0.001

# erm
# python train.py --data_dir $data_dir --max_epoch $max_epoch --net $net --task $task --output pacs_/resnet18/a/erm \
# --test_envs 0 --dataset $dataset --algorithm ${algorithm[i]} --lr $lr 
...
# erm
python train.py --data_dir $data_dir --max_epoch $max_epoch --net $net --task $task --output pacs_e/resnet50/a/erm \
--test_envs 0 --dataset $dataset --algorithm ${algorithm[i]} --lr $lr 

python train.py --data_dir $data_dir --max_epoch $max_epoch --net $net --task $task --output pacs_e/resnet50/c/erm \
--test_envs 1 --dataset $dataset --algorithm ${algorithm[i]} --lr $lr 

python train.py --data_dir $data_dir --max_epoch $max_epoch --net $net --task $task --output pacs_e/resnet50/p/erm \
--test_envs 2 --dataset $dataset --algorithm ${algorithm[i]} --lr $lr 

python train.py --data_dir $data_dir --max_epoch $max_epoch --net $net --task $task --output pacs_e/resnet50/s/erm \
--test_envs 3 --dataset $dataset --algorithm ${algorithm[i]} --lr $lr 
